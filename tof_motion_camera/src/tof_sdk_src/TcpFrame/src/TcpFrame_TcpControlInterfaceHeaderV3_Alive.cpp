///////////////////////////////////////////////////////////////////////////
//     PROJECT: Cpp -- TcpControlInterfaceHeaderV3_Alive
//   COPYRIGHT: R. Hranitzky
//    $RCSfile$
//   $Revision: 4479 $
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The implementation for class TcpControlInterfaceHeaderV3_Alive 
//              used /usr/local/bin/CppClassCoder.pl to create this file
//              created Fri Feb  9 17:10:37 2018
...
//------------------------------ Includes ------------------------------
#include "stdafx.h"
#include "TcpFrame_TcpControlInterfaceHeaderV3_Alive.h"
...
TcpControlInterfaceHeaderV3_Alive::TcpControlInterfaceHeaderV3_Alive ( ) 
: its0Preamble ( 41452 )
...
bool TcpControlInterfaceHeaderV3_Alive::WriteToBuffer( uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset ) const
{
...
bool TcpControlInterfaceHeaderV3_Alive::ReadFromBuffer( const uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset )
{
...
//------------------------------ Logging ------------------------------
void TcpControlInterfaceHeaderV3_Alive::Log( ostream & aStreamRef ) const
{
   Common::LogFormat tmpLogFormat( 10 );
   Log( aStreamRef, tmpLogFormat );
}

void TcpControlInterfaceHeaderV3_Alive::Log( ostream & aStreamRef, Common::LogFormat & aLogFormat ) const
{
   aLogFormat . LogBeginStruct( aStreamRef, "TcpFrame_TcpControlInterfaceHeaderV3_Alive" );
