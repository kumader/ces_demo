...
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The implementation for class TcpControlInterfaceHeaderV3_RegisterRead 
...
TcpControlInterfaceHeaderV3_RegisterRead::TcpControlInterfaceHeaderV3_RegisterRead ( ) 
: its0Preamble ( 41452 )
...
bool TcpControlInterfaceHeaderV3_RegisterRead::WriteToBuffer( uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset ) const
{
...
bool TcpControlInterfaceHeaderV3_RegisterRead::ReadFromBuffer( const uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset )
{
...
//------------------------------ Logging ------------------------------
void TcpControlInterfaceHeaderV3_RegisterRead::Log( ostream & aStreamRef ) const
{
   Common::LogFormat tmpLogFormat( 10 );
   Log( aStreamRef, tmpLogFormat );
}

void TcpControlInterfaceHeaderV3_RegisterRead::Log( ostream & aStreamRef, Common::LogFormat & aLogFormat ) const
{
   aLogFormat . LogBeginStruct( aStreamRef, "TcpFrame_TcpControlInterfaceHeaderV3_RegisterRead" );
