...
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The implementation for class TcpControlInterfaceHeaderV3_RegisterWriteResponse 
...
TcpControlInterfaceHeaderV3_RegisterWriteResponse::TcpControlInterfaceHeaderV3_RegisterWriteResponse ( ) 
: its0Preamble ( 41452 )
...
bool TcpControlInterfaceHeaderV3_RegisterWriteResponse::WriteToBuffer( uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset ) const
{
...
bool TcpControlInterfaceHeaderV3_RegisterWriteResponse::ReadFromBuffer( const uint1 * buffer, uint2 aBufferSize, uint2 & aByteOffset )
{
...
//------------------------------ Logging ------------------------------
void TcpControlInterfaceHeaderV3_RegisterWriteResponse::Log( ostream & aStreamRef ) const
{
   Common::LogFormat tmpLogFormat( 10 );
   Log( aStreamRef, tmpLogFormat );
}

void TcpControlInterfaceHeaderV3_RegisterWriteResponse::Log( ostream & aStreamRef, Common::LogFormat & aLogFormat ) const
{
   aLogFormat . LogBeginStruct( aStreamRef, "TcpFrame_TcpControlInterfaceHeaderV3_RegisterWriteResponse" );
