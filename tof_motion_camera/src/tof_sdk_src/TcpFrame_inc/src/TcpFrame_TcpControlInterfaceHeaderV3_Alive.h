...
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The definitions for class TcpControlInterfaceHeaderV3_Alive 
//              used /usr/local/bin/CppClassCoder.pl to create this file
//              created Fri Feb  9 17:10:37 2018
//              automatically generated code
///////////////////////////////////////////////////////////////////////////

#ifndef _TcpFrame_TcpControlInterfaceHeaderV3_Alive_
#define _TcpFrame_TcpControlInterfaceHeaderV3_Alive_
...
/// The definition of class TcpControlInterfaceHeaderV3_Alive
class TcpControlInterfaceHeaderV3_Alive
{
public:
   ...
   /// Default Constructor
        TcpControlInterfaceHeaderV3_Alive( );
   ...
   /// Equal operator 
       bool operator == (const TcpControlInterfaceHeaderV3_Alive & aRef) const;
...
}; // End of class TcpControlInterfaceHeaderV3_Alive

//------------------------------ Inline Functions ----------------------
inline bool TcpControlInterfaceHeaderV3_Alive::operator == (const TcpControlInterfaceHeaderV3_Alive & aRef) const
{
...
inline std::ostream & operator << ( std::ostream & aStreamRef, const TcpControlInterfaceHeaderV3_Alive & aRef )
{
   aRef . Log( aStreamRef );
   return aStreamRef;
}

inline uint2 TcpControlInterfaceHeaderV3_Alive::Get6Flags( ) const
{
 return its6Flags;
}

inline void TcpControlInterfaceHeaderV3_Alive::Set6Flags( const uint2 & aValue )
{
 its6Flags = aValue;
}

inline uint4 TcpControlInterfaceHeaderV3_Alive::Get58DataCrc32( ) const
{
 return its58DataCrc32;
}

inline void TcpControlInterfaceHeaderV3_Alive::Set58DataCrc32( const uint4 & aValue )
{
 its58DataCrc32 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_Alive::Get62HeaderCrc16( ) const
{
 return its62HeaderCrc16;
}

inline void TcpControlInterfaceHeaderV3_Alive::Set62HeaderCrc16( const uint2 & aValue )
{
