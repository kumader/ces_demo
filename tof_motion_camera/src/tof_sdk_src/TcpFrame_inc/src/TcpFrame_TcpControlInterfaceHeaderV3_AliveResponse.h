...
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The definitions for class TcpControlInterfaceHeaderV3_AliveResponse 
//              used /usr/local/bin/CppClassCoder.pl to create this file
//              created Fri Feb  9 17:10:41 2018
//              automatically generated code
///////////////////////////////////////////////////////////////////////////

#ifndef _TcpFrame_TcpControlInterfaceHeaderV3_AliveResponse_
#define _TcpFrame_TcpControlInterfaceHeaderV3_AliveResponse_
...
/// The definition of class TcpControlInterfaceHeaderV3_AliveResponse
class TcpControlInterfaceHeaderV3_AliveResponse
{
public:
   ...
   /// Default Constructor
        TcpControlInterfaceHeaderV3_AliveResponse( );
   ...
   /// Equal operator 
       bool operator == (const TcpControlInterfaceHeaderV3_AliveResponse & aRef) const;
...
private:
   ...
   //   All the Elements
         ...
         uint2 its6Flags;
         uint4 its8Length;
         uint1 its12HeaderData0;
         uint1 its13HeaderData1;
...
}; // End of class TcpControlInterfaceHeaderV3_AliveResponse

//------------------------------ Inline Functions ----------------------
inline bool TcpControlInterfaceHeaderV3_AliveResponse::operator == (const TcpControlInterfaceHeaderV3_AliveResponse & aRef) const
{
   ...
   if ( ! (its12HeaderData0 == aRef.its12HeaderData0) ) return false;
   if ( ! (its13HeaderData1 == aRef.its13HeaderData1) ) return false;
...
inline std::ostream & operator << ( std::ostream & aStreamRef, const TcpControlInterfaceHeaderV3_AliveResponse & aRef )
{
   aRef . Log( aStreamRef );
   return aStreamRef;
}

inline uint1 TcpControlInterfaceHeaderV3_AliveResponse::Get5Status( ) const
{
 return its5Status;
}

inline void TcpControlInterfaceHeaderV3_AliveResponse::Set5Status( const uint1 & aValue )
{
 its5Status = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_AliveResponse::Get6Flags( ) const
{
 return its6Flags;
}

inline void TcpControlInterfaceHeaderV3_AliveResponse::Set6Flags( const uint2 & aValue )
{
 its6Flags = aValue;
}

inline uint4 TcpControlInterfaceHeaderV3_AliveResponse::Get58DataCrc32( ) const
{
 return its58DataCrc32;
}

inline void TcpControlInterfaceHeaderV3_AliveResponse::Set58DataCrc32( const uint4 & aValue )
{
 its58DataCrc32 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_AliveResponse::Get62HeaderCrc16( ) const
{
 return its62HeaderCrc16;
}

inline void TcpControlInterfaceHeaderV3_AliveResponse::Set62HeaderCrc16( const uint2 & aValue )
{
...
inline std::string TcpControlInterfaceHeaderV3_AliveResponse::ConvertToString5Status( const uint1 & aValue ) const
{
 switch (aValue)
 {
