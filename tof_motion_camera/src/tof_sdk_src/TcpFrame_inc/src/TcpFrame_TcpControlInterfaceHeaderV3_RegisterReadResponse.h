///////////////////////////////////////////////////////////////////////////
//     PROJECT: Cpp -- TcpControlInterfaceHeaderV3_RegisterReadResponse
//   COPYRIGHT: R. Hranitzky
//    $RCSfile$
//   $Revision: 4479 $
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The definitions for class TcpControlInterfaceHeaderV3_RegisterReadResponse 
//              used /usr/local/bin/CppClassCoder.pl to create this file
//              created Fri Feb  9 17:10:51 2018
//              automatically generated code
///////////////////////////////////////////////////////////////////////////

#ifndef _TcpFrame_TcpControlInterfaceHeaderV3_RegisterReadResponse_
#define _TcpFrame_TcpControlInterfaceHeaderV3_RegisterReadResponse_
...
/// The definition of class TcpControlInterfaceHeaderV3_RegisterReadResponse
class TcpControlInterfaceHeaderV3_RegisterReadResponse
{
public:
   ...
   /// Default Constructor
        TcpControlInterfaceHeaderV3_RegisterReadResponse( );
   ...
   /// Equal operator 
       bool operator == (const TcpControlInterfaceHeaderV3_RegisterReadResponse & aRef) const;
   ...
   //@{
         ...
         //----------------------------------------------------
         // The member 64RegisterValue
         ///  The Get function for member 64RegisterValue
              uint2   Get64RegisterValue( ) const;
         ///  The Set function for member 64RegisterValue
              void    Set64RegisterValue( const uint2 & aValue );
         //----------------------------------------------------
...
private:
   ...
   //   All the Elements
         ...
         uint2 its64RegisterValue;


}; // End of class TcpControlInterfaceHeaderV3_RegisterReadResponse

//------------------------------ Inline Functions ----------------------
inline bool TcpControlInterfaceHeaderV3_RegisterReadResponse::operator == (const TcpControlInterfaceHeaderV3_RegisterReadResponse & aRef) const
{
   ...
   if ( ! (its64RegisterValue == aRef.its64RegisterValue) ) return false;
...
inline std::ostream & operator << ( std::ostream & aStreamRef, const TcpControlInterfaceHeaderV3_RegisterReadResponse & aRef )
{
   aRef . Log( aStreamRef );
   return aStreamRef;
}

inline uint1 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get5Status( ) const
{
 return its5Status;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set5Status( const uint1 & aValue )
{
 its5Status = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get6Flags( ) const
{
 return its6Flags;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set6Flags( const uint2 & aValue )
{
 its6Flags = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get12RegisterAddress( ) const
{
 return its12RegisterAddress;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set12RegisterAddress( const uint2 & aValue )
{
 its12RegisterAddress = aValue;
}

inline uint4 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get58DataCrc32( ) const
{
 return its58DataCrc32;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set58DataCrc32( const uint4 & aValue )
{
 its58DataCrc32 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get62HeaderCrc16( ) const
{
 return its62HeaderCrc16;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set62HeaderCrc16( const uint2 & aValue )
{
 its62HeaderCrc16 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterReadResponse::Get64RegisterValue( ) const
{
 return its64RegisterValue;
}

inline void TcpControlInterfaceHeaderV3_RegisterReadResponse::Set64RegisterValue( const uint2 & aValue )
{
 its64RegisterValue = aValue;
}




inline std::string TcpControlInterfaceHeaderV3_RegisterReadResponse::ConvertToString5Status( const uint1 & aValue ) const
{
 switch (aValue)
 {
