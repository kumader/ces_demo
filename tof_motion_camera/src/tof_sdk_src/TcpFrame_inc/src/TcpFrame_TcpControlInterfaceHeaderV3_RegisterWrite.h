...
//      AUTHOR: R. Hranitzky
//    LANGUAGE: C++ 
// DESCRIPTION: The definitions for class TcpControlInterfaceHeaderV3_RegisterWrite 
//              used /usr/local/bin/CppClassCoder.pl to create this file
//              created Fri Feb  9 17:10:55 2018
//              automatically generated code
///////////////////////////////////////////////////////////////////////////

#ifndef _TcpFrame_TcpControlInterfaceHeaderV3_RegisterWrite_
#define _TcpFrame_TcpControlInterfaceHeaderV3_RegisterWrite_
...
/// The definition of class TcpControlInterfaceHeaderV3_RegisterWrite
class TcpControlInterfaceHeaderV3_RegisterWrite
{
public:
   ...
   /// Default Constructor
        TcpControlInterfaceHeaderV3_RegisterWrite( );
   ...
   /// Equal operator 
       bool operator == (const TcpControlInterfaceHeaderV3_RegisterWrite & aRef) const;
...
}; // End of class TcpControlInterfaceHeaderV3_RegisterWrite

//------------------------------ Inline Functions ----------------------
inline bool TcpControlInterfaceHeaderV3_RegisterWrite::operator == (const TcpControlInterfaceHeaderV3_RegisterWrite & aRef) const
{
...
inline std::ostream & operator << ( std::ostream & aStreamRef, const TcpControlInterfaceHeaderV3_RegisterWrite & aRef )
{
   aRef . Log( aStreamRef );
   return aStreamRef;
}

inline uint1 TcpControlInterfaceHeaderV3_RegisterWrite::Get5Status( ) const
{
 return its5Status;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set5Status( const uint1 & aValue )
{
 its5Status = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterWrite::Get6Flags( ) const
{
 return its6Flags;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set6Flags( const uint2 & aValue )
{
 its6Flags = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterWrite::Get12RegisterAddress( ) const
{
 return its12RegisterAddress;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set12RegisterAddress( const uint2 & aValue )
{
 its12RegisterAddress = aValue;
}

inline uint4 TcpControlInterfaceHeaderV3_RegisterWrite::Get58DataCrc32( ) const
{
 return its58DataCrc32;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set58DataCrc32( const uint4 & aValue )
{
 its58DataCrc32 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterWrite::Get62HeaderCrc16( ) const
{
 return its62HeaderCrc16;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set62HeaderCrc16( const uint2 & aValue )
{
 its62HeaderCrc16 = aValue;
}

inline uint2 TcpControlInterfaceHeaderV3_RegisterWrite::Get64RegisterValue( ) const
{
 return its64RegisterValue;
}

inline void TcpControlInterfaceHeaderV3_RegisterWrite::Set64RegisterValue( const uint2 & aValue )
{
